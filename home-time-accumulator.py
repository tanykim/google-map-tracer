...
DEFAULT_TIMEZONE = pytz.timezone(setup.DEFAULT_TIMEZONE)
YEAR = 2018
...
with open('Takeout/Location History/Location History.json') as file:
    data = json.load(file)
    ...
    for i in range(len(data['locations'])):
        ...
        if year == YEAR:
            ...
            # probably home - some lat and log are slightly off, this could be an acceptable range
...
# save data as json
# change the file location and name to suit your environment.
fd = open('../quantify-your-self/src/data/tanyoung-time-at-home-' + str(YEAR) + '.json', 'w', encoding='utf8')
